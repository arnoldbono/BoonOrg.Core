...
{
    public class CoordinateYPropertyProducer : IPropertyProducer
    {
        private readonly PropertyValueDoubleProducer m_propertyProducer;
    
        public string Name => @"Coordinate y";

        public CoordinateYPropertyProducer(PropertyValueDoubleProducer propertyProducer)
        {
        ...
        {
            return m_propertyProducer.Produce(vertices, (x, y, z) => y, Name);
        }
    }
}
