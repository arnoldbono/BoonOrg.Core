...
{
    public class HeightPropertyProducer : IPropertyProducer
    {
        private readonly PropertyValueDoubleProducer m_propertyProducer;

        public string Name => @"Height";

        public HeightPropertyProducer(PropertyValueDoubleProducer propertyProducer)
        {
        ...
        {
            return m_propertyProducer.Produce(vertices, (x, y, z) => z, Name);
        }
    }
}
